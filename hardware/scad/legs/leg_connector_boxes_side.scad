...
module box(dist){
     ...
     difference(){
          ...
          translate([0, hub_y, 5])cube([2*hub_x, 2*hub_y, 4], center=true);
          // connector hole
          translate([0, -10, -0.5])rotate([90, 0, 0])cube([hub_x+0.1, hub_y+0.1, 20], center=true);
     }
     translate([-dist, 0, -0.])cylinder(h=8, r=3, center=true, $fn=50);
     translate([+dist, 0, -0.])cylinder(h=8, r=3, center=true, $fn=50);
}
